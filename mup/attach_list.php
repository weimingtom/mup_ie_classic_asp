...
<td width="50%"><a href="attach.php?filename=<?php echo $value;?>" target="_blank"><?php echo $value;?></a></td><td width="50%"><a href="attach_list.php?r=<?php echo $value;?>">删除文件</a></td>
</tr>
